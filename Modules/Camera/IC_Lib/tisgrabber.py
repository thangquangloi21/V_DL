...
class TIS_GrabberDLL(object):
    ...
    if sys.maxsize > 2**32 :
        # os.chdir('./Modules/Camera/IC_Lib')
        __tisgrabber = C.windll.LoadLibrary("./Modules/Camera/IC_Lib/tisgrabber_x64.dll")
    else:
        __tisgrabber = C.windll.LoadLibrary("./Modules/Camera/IC_Lib/tisgrabber.dll")
